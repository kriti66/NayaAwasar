...
void Sample()
{
    ...
    uint64_t effectiveTimeInSeconds = 3600; // token expiration time, in seconds
...
//
// Example code for generating authorization tokens. Contact ZEGO technical support to enable this feature before using it.
//
void SampleForRTCRoom()
{
    ...
    std::string userID = "demo";
    std::string secret = "12345678900987654321123456789012";
    // This indicates that login and publishing are allowed; changing the value from 1 to 0 means not allowed
