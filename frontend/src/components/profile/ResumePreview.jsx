            ...
            <div className="p-6">
                ...
                <div className="rounded-2xl overflow-hidden border border-gray-100 shadow-sm bg-white mb-8 group transition-transform hover:scale-[1.01]">
                    ...
                    <div className="p-5 space-y-6">
                        <div className="space-y-3">
                            <p className="text-[9px] font-black text-blue-600 uppercase tracking-widest border-l-2 border-blue-500 pl-2">Contact</p>
                        ...
                        <div className="space-y-3">
                            <p className="text-[9px] font-black text-blue-600 uppercase tracking-widest border-l-2 border-blue-500 pl-2">Top Skills</p>
                            <div className="flex flex-wrap gap-1.5">
                                {profile.skills ? profile.skills.split(',').slice(0, 5).map((s, i) => (
                                    <span key={i} className="px-2 py-1 bg-gray-50 text-[8px] font-black text-gray-400 rounded-md border border-gray-100 uppercase tracking-tighter group-hover:bg-blue-50 group-hover:text-blue-500 transition-colors">
                                        {s.trim()}
                                    </span>
                ...
                <div className="space-y-3">
                    <button
                        ...
                        className="w-full py-3.5 bg-blue-600 text-white text-[10px] font-black uppercase tracking-widest rounded-xl flex items-center justify-center gap-2 hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/10 active:scale-[0.98]"
                    >
                        <Download size={14} />
                        Download as PDF
                    </button>
                    ...
                    <label className="w-full py-3.5 border border-dashed border-gray-100 text-gray-400 hover:border-blue-200 hover:text-blue-600 hover:bg-blue-50/50 text-[10px] font-black uppercase tracking-widest rounded-xl flex items-center justify-center gap-2 transition-all cursor-pointer bg-gray-50/30 group">
