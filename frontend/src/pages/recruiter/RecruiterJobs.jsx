            ...
            <main className="flex-1 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full py-10">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                    ...
                    <Link
                        ...
                        className="inline-flex items-center px-6 py-3 border border-transparent rounded-xl shadow-sm text-sm font-bold text-white bg-[#29a08e] hover:bg-[#228377] hover:shadow-lg hover:shadow-[#29a08e]/20 transition-all transform active:scale-95"
                    >
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6 flex flex-col md:flex-row gap-4 items-center justify-between">
                    <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
                        ...
                        <div className="relative group">
                            <select
                                className="appearance-none bg-gray-50 border border-gray-200 text-gray-700 py-2.5 pl-4 pr-10 rounded-lg text-sm font-bold focus:outline-none focus:ring-2 focus:ring-[#29a08e]/20 focus:border-[#29a08e] cursor-pointer hover:bg-gray-100 transition-colors"
                                value={filterStatus}
                ...
                <div className="space-y-4">
                    {loading ? (
                        <div className="text-center py-20">
                            <div className="inline-block animate-spin rounded-full h-8 w-8 border-4 border-[#29a08e] border-t-transparent"></div>
                            ...
                            <div key={job.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col md:flex-row justify-between hover:shadow-md transition-all group">
                                <div className="flex-1">
                                    <div className="flex items-center gap-3 mb-2">
                                        <h3 className="text-lg font-bold text-gray-900 group-hover:text-[#29a08e] transition-colors">
                                            {job.title}
                                        </h3>
                                        <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider
                                            ${(job.status || 'Active') === 'Active' ? 'bg-emerald-50 text-[#29a08e]' : 'bg-gray-100 text-gray-500'}
                                        `}>
                                            {job.status || 'Active'}
                                        </span>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div className="flex items-center gap-2 text-sm font-bold text-gray-700">
                                            <Eye size={16} className="text-[#29a08e]" />
                                ...
                                <div className="mt-6 md:mt-0 flex flex-col items-end gap-3 justify-center pl-0 md:pl-6 md:border-l border-gray-100">
                                    <button
                                        ...
                                        className="w-full md:w-auto px-4 py-2 bg-[#29a08e] text-white text-xs font-bold rounded-lg hover:bg-[#228377] shadow-sm shadow-[#29a08e]/20 flex items-center justify-center gap-2 transition-all"
                                    >
                                        <PieChart size={14} />
                                        View Analytics
                                    </button>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
                            ...
                            <Link
                                to="/recruiter/post-job"
                                className="inline-flex items-center px-6 py-3 bg-[#29a08e] text-white text-sm font-bold rounded-lg hover:bg-[#228377] transition-colors"
                            >
