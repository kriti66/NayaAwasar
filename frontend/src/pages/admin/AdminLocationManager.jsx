                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                    <div>
                        ...
                        <p className="text-gray-400 mt-1.5 font-medium text-sm">
                            Set the physical address, phone, and email shown on the public Contact page. The map is generated from the address automatically — no coordinates needed.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="p-8 space-y-8">
                        <div className="border-b border-gray-100 pb-5 flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xs text-gray-400 mt-1.5 ml-9">These details appear on Contact Us and power the embedded map.</p>
                            </div>
                        </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="col-span-2 space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            rows={3}
                                            required
                                            className="block w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm font-semibold text-gray-900 focus:bg-white focus:ring-2 focus:ring-[#29a08e]/30 focus:border-[#29a08e] transition-all outline-none resize-y"
                                            placeholder="Full street address, city, country (used for the map)"
                                        />
                                    </div>
