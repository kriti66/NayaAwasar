...
const Profile = () => {
        ...
        return (
            <div className="flex h-screen bg-white items-center justify-center">
                <div className="animate-pulse space-y-4 text-center">
                    <div className="w-12 h-12 bg-[#29a08e]/20 rounded-full mx-auto"></div>
    ...
    return (
        <div className="min-h-screen flex flex-col bg-[#FDFEFE] font-sans selection:bg-[#29a08e]/20 selection:text-[#212121]">
            <DashboardNavbar />
                            ...
                            <section className="bg-white border border-slate-100 rounded-2xl p-8 shadow-sm group hover:shadow-md transition-shadow">
                                <div className="flex justify-between items-center mb-8 pb-4 border-b border-slate-50">
                                    ...
                                    <button
                                        ...
                                        className="text-xs font-bold text-slate-400 hover:text-[#29a08e] flex items-center gap-1.5 px-3 py-1.5 rounded-lg hover:bg-[#29a08e]/10 transition-all border border-transparent hover:border-[#29a08e]/20"
                                    >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-sm font-semibold text-slate-800 text-[#29a08e]">{profile.professionalHeadline || 'Add a headline...'}</p>
                                    </div>
                            ...
                            <section className="bg-white border border-slate-100 rounded-2xl p-8 shadow-sm group hover:shadow-md transition-shadow">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        {profile.linkedinUrl ? (
                                            <a href={profile.linkedinUrl} target="_blank" className="text-sm font-semibold text-[#29a08e] truncate block">Profile Link</a>
                                        ) : (
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        {profile.portfolioUrl ? (
                                            <a href={profile.portfolioUrl} target="_blank" className="text-sm font-semibold text-[#29a08e] truncate block">Example URL</a>
                                        ) : (
                                            <p className="text-sm font-medium text-slate-400 italic">Not added</p>
                                        )}
                                    </div>
                                ...
                                <div className="space-y-8">
                                    {profile.workExperience?.length > 0 ? profile.workExperience.map((exp, i) => (
                                        <div key={i} className="relative pl-6 border-l-2 border-slate-100 py-2">
                                            <div className="absolute top-0 left-[-7px] w-3 h-3 bg-[#29a08e] rounded-full border-2 border-white shadow-sm"></div>
                            ...
                            <section className="bg-white border border-slate-100 rounded-2xl p-8 shadow-sm group hover:shadow-md transition-shadow">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {profile.skills ? profile.skills.split(',').map((skill, i) => (
                                        <span key={i} className="px-3 py-1.5 bg-[#29a08e]/10 text-[#29a08e] rounded-lg text-xs font-bold border border-[#29a08e]/20">
                                            {skill.trim()}
                                        </span>
                                    )) : (
                        ...
                        <div className="space-y-8">
                            <div className="bg-white border border-slate-100 rounded-2xl p-8 shadow-sm sticky top-24">
                                ...
                                <div className="mt-8 space-y-3">
                                    <button className="w-full py-4 text-xs font-black text-slate-500 hover:text-[#29a08e] flex items-center justify-center gap-2 border border-slate-100 rounded-xl hover:bg-[#29a08e]/10 transition-all">
                                    ...
                                    <button className="w-full py-4 bg-[#29a08e] text-white rounded-xl text-xs font-black shadow-lg shadow-[#29a08e]/20 hover:bg-[#228377] transition-all flex items-center justify-center gap-2">
                    ...
                    <div className="fixed inset-0 z-[100] bg-[#0F172A]/80 backdrop-blur-md flex items-center justify-center p-6 sm:p-10 animate-in fade-in duration-300">
                        <div className="bg-white w-full max-w-2xl rounded-2xl shadow-2xl flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-300">
                            ...
                            <div className="flex-1 overflow-y-auto p-8 space-y-8 custom-scrollbar">
                                ...
                                {editingSection === 'personal' && (
                                    <>
                                        <div className="space-y-2">
                                            ...
                                            <input name="fullName" value={formData.fullName} onChange={handleChange} className="w-full p-4 rounded-xl border-2 border-slate-100 focus:border-[#29a08e] focus:ring-4 focus:ring-[#29a08e]/10 outline-none transition-all font-semibold" />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-bold text-slate-400 tracking-widest uppercase">Professional Headline</label>
                                            <input name="professionalHeadline" value={formData.professionalHeadline} onChange={handleChange} className="w-full p-4 rounded-xl border-2 border-slate-100 focus:border-[#29a08e] focus:ring-4 focus:ring-[#29a08e]/10 outline-none transition-all font-semibold" placeholder="e.g. Senior Software Engineer | Full-stack Developer" />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-bold text-slate-400 tracking-widest uppercase">Bio (Max 500 chars)</label>
                                            <textarea name="bio" value={formData.bio} onChange={handleChange} rows="5" className="w-full p-4 rounded-xl border-2 border-slate-100 focus:border-[#29a08e] focus:ring-4 focus:ring-[#29a08e]/10 outline-none transition-all font-semibold resize-none" maxLength="500"></textarea>
                                        </div>
                                    </>
                                )}
                                ...
                                {editingSection === 'contact' && (
                                    <>
                                        <div className="space-y-2">
                                            ...
                                            <input name="phoneNumber" value={formData.phoneNumber} onChange={handleChange} className="w-full p-4 rounded-xl border-2 border-slate-100 focus:border-[#29a08e] focus:ring-4 focus:ring-[#29a08e]/10 outline-none transition-all font-semibold" />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-bold text-slate-400 tracking-widest uppercase">LinkedIn URL</label>
                                            <input name="linkedinUrl" value={formData.linkedinUrl} onChange={handleChange} className="w-full p-4 rounded-xl border-2 border-slate-100 focus:border-[#29a08e] focus:ring-4 focus:ring-[#29a08e]/10 outline-none transition-all font-semibold" />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-bold text-slate-400 tracking-widest uppercase">Portfolio/Portfolio Website</label>
                                            <input name="portfolioUrl" value={formData.portfolioUrl} onChange={handleChange} className="w-full p-4 rounded-xl border-2 border-slate-100 focus:border-[#29a08e] focus:ring-4 focus:ring-[#29a08e]/10 outline-none transition-all font-semibold" />
                                        </div>
                                    </>
                                )}
                                            ...
                                            <div key={i} className="p-6 bg-slate-50/50 border border-slate-100 rounded-2xl relative space-y-4">
                                                ...
                                                <div className="grid grid-cols-2 gap-4">
                                                    <div className="space-y-1">
                                                        ...
                                                        <input value={exp.title} onChange={(e) => handleArrayChange('workExperience', i, 'title', e.target.value)} className="w-full p-3 rounded-lg border border-slate-100 focus:border-[#29a08e] text-sm font-bold" />
                                                    </div>
                                                    <div className="space-y-1">
                                                        <label className="text-[9px] font-black text-slate-400 tracking-widest uppercase">Company</label>
                                                        <input value={exp.company} onChange={(e) => handleArrayChange('workExperience', i, 'company', e.target.value)} className="w-full p-3 rounded-lg border border-slate-100 focus:border-[#29a08e] text-sm font-bold" />
                                                    </div>
                                                </div>
                                                <div className="space-y-1">
                                                    <label className="text-[9px] font-black text-slate-400 tracking-widest uppercase">Duration (e.g. Jan 2020 - Present)</label>
                                                    <input value={exp.duration} onChange={(e) => handleArrayChange('workExperience', i, 'duration', e.target.value)} className="w-full p-3 rounded-lg border border-slate-100 focus:border-[#29a08e] text-sm font-bold" />
                                                </div>
                                                <div className="space-y-1">
                                                    <label className="text-[9px] font-black text-slate-400 tracking-widest uppercase">Description</label>
                                                    <textarea value={exp.description} onChange={(e) => handleArrayChange('workExperience', i, 'description', e.target.value)} className="w-full p-3 rounded-lg border border-slate-100 focus:border-[#29a08e] text-sm font-medium resize-none" rows="3"></textarea>
                                                </div>
                                            </div>
                                        ))}
                                        <button onClick={() => addArrayItem('workExperience', { title: '', company: '', duration: '', description: '' })} className="w-full py-4 border-2 border-dashed border-slate-200 rounded-2xl text-slate-400 font-bold hover:bg-slate-50 hover:border-[#29a08e] hover:text-[#29a08e] transition-all text-sm">+ Add Experience</button>
                                    </div>
                                )}
                                        ...
                                        {formData.education.map((edu, i) => (
                                            <div key={i} className="p-6 bg-slate-50/50 border border-slate-100 rounded-2xl relative space-y-4">
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <input value={edu.degree} onChange={(e) => handleArrayChange('education', i, 'degree', e.target.value)} className="w-full p-3 rounded-lg border border-slate-100 focus:border-[#29a08e] text-sm font-bold" />
                                                </div>
                                                <div className="grid grid-cols-2 gap-4">
                                                    <div className="space-y-1">
                                                        <label className="text-[9px] font-black text-slate-400 tracking-widest uppercase">Institution</label>
                                                        <input value={edu.institution} onChange={(e) => handleArrayChange('education', i, 'institution', e.target.value)} className="w-full p-3 rounded-lg border border-slate-100 focus:border-[#29a08e] text-sm font-bold" />
                                                    </div>
                                                    <div className="space-y-1">
                                                        <label className="text-[9px] font-black text-slate-400 tracking-widest uppercase">Year</label>
                                                        <input value={edu.year} onChange={(e) => handleArrayChange('education', i, 'year', e.target.value)} className="w-full p-3 rounded-lg border border-slate-100 focus:border-[#29a08e] text-sm font-bold" />
                                                    </div>
                                                </div>
                                            </div>
                                        ))}
                                        <button onClick={() => addArrayItem('education', { degree: '', institution: '', year: '' })} className="w-full py-4 border-2 border-dashed border-slate-200 rounded-2xl text-slate-400 font-bold hover:bg-slate-50 hover:border-[#29a08e] hover:text-[#29a08e] transition-all text-sm">+ Add Education History</button>
                                    </div>
                                )}
                                ...
                                {editingSection === 'skills' && (
                                    <div className="space-y-2">
                                        ...
                                        <textarea name="skills" value={formData.skills} onChange={handleChange} rows="4" className="w-full p-4 rounded-xl border-2 border-slate-100 focus:border-[#29a08e] focus:ring-4 focus:ring-[#29a08e]/10 outline-none transition-all font-semibold resize-none" placeholder="React, Node.js, Project Management, Figma..."></textarea>
                            ...
                            <div className="p-8 bg-slate-50/50 border-t border-slate-100 flex gap-4">
                                ...
                                <button onClick={() => handleUpdate(editingSection)} className="flex-[2] py-4 bg-[#29a08e] text-white rounded-xl font-black shadow-xl shadow-[#29a08e]/20 hover:bg-[#228377] transition-all text-sm">Save Changes</button>
                            </div>
                        </div>
                    </div>
                )}
